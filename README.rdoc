...
=== Create a newsletter
  ...
  rails generate maktoub:newsletter

This generator creates a template file in app/views/maktoub/newsletters/ that will use to write your newsletter.

You can display all your newsletters from this URL (only in development environment) :
  
  /newsletters (can be different if you mount the engine in a specific route... see below)
